      ...
      <section className="mx-auto max-w-5xl px-6 lg:px-10 py-20 grid md:grid-cols-2 gap-6">
        ...
        >
          <div className="w-14 h-14 rounded-2xl bg-white/10 grid place-items-center mb-6 border border-white/15">
            <svg
              viewBox="0 0 24 24"
              className="w-7 h-7 text-[color:var(--gold-soft)]"
              fill="currentColor"
              aria-hidden
            >
          ...
          <div className="text-xs uppercase tracking-wider text-[color:var(--gold-soft)] font-semibold">
            WhatsApp
          </div>
        ...
        <div className="rounded-3xl bg-white border border-[color:var(--border)] p-10 shadow-soft space-y-6">
          <InfoRow
            ...
            label="E-mail"
            value={
              <a href={`mailto:${COMPANY.email}`} className="hover:text-[color:var(--forest-deep)]">
                {COMPANY.email}
              </a>
            }
          />
          <InfoRow
            ...
            value={
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="hover:text-[color:var(--forest-deep)]"
              >
